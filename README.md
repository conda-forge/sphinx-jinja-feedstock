...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinx-jinja-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8916&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinx-jinja-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinx-jinja` can be installed with:

```
conda install sphinx-jinja
```

It is possible to list all of the versions of `sphinx-jinja` available on your platform with:
